  ...
  return (
    <div className='experiences-content'>
      ...
      <CardExperiences 
        ...
        description = "Founded and led an AI-focused startup developing real-time Khmer and Japanese license plate recognition systems using YOLO+Keras. Achieved 76% accuracy (Khmer) and 70% (Japanese) through iterative model refinement and QA testing. Won 1st Place at Bandos Tech Startup Competition with a $10,000 innovation grant. Selected as a Top 5 Startup at COMEUP 2023 in Seoul, showcasing AI solutions on an international stage." 
